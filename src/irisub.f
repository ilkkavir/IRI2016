...
C 2015.04 02/01/16 if(hef.le.hme)  no F1 and no valley .... M.Hausman
C
C*****************************************************************
...
8449    FORMAT(1X////,
     &    ' The file ',A112,'is not in your directory.')
        GOTO 3330
C
...
c     &  	   height,daynr,f107d,xic_O,xic_H,xic_He,xic_N)
			call CALION(invdip,xmlt,height,daynr,f107d,
